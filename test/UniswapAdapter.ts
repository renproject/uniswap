...
import { UniswapExchangeInstance, UniswapReserveAdapterInstance, UniswapExchangeAdapterInstance, ShifterInstance, zBTCInstance } from "../types/truffle-contracts";
...
contract("UniswapAdapter", ([trader, reserveOwner]) => {
    ...
    before(async () => {
        ...
        btcShifter = await Shifter.new("0x0000000000000000000000000000000000000000", zbtc.address, "0x0000000000000000000000000000000000000000", mintAuthority.address, 0);
    ...
    it("Can add liquidity", async () => {
        ...
        (await zbtc.totalSupply()).should.equal(new BN(200000));
    });
    ...
    it("Can remove liquidity", async () => {
        ...
        await uniswapReserveAdapter.removeLiquidity(uniAmount, 5000, 5000, deadline, "", {from: reserveOwner});
